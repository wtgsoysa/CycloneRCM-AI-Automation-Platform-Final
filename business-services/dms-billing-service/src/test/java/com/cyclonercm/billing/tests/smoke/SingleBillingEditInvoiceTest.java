...
public class SingleBillingEditInvoiceTest extends SmokeBaseTest {
    ...
    public void setUp() {
     ...
     //WaitUtils.sleep(1000);
        ...
        try {
            // Step 1: Navigate to Single Billing
            WaitUtils.sleep(3000);
            System.out.println("\n📍 Step 1: Navigating to Single Billing section...");
            singleBillingPage.clickBillingMenu();
            singleBillingPage.clickSingleBillingOption();
            WaitUtils.sleep(5000);
            System.out.println("✓ Single Billing page loaded");

            // Step 2: Add ONE invoice to Single Billing
            System.out.println("\n📝 Step 2: Adding one invoice to Single Billing...");
            ...
            if (singleBillingPage.viewApplicantList()) {
                ...
                if (dosCount > 0) {
                    ...
                    System.out.println("✓ Invoice added to Single Billing");
                }
            }

            // Step 3: Click first invoice number to open Edit Invoice
            System.out.println("\n🔗 Step 3: Clicking invoice number to open Edit Invoice...");
            singleBillingPage.clickFirstInvoiceNumber();
