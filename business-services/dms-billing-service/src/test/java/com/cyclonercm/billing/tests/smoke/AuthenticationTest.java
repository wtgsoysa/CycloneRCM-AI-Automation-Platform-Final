...
/**
 * Smoke Tests for Billing Service
 * TC-AUT-001: Verify user can successfully login with valid User Id and Password
 * TC-AUT-002: Verify Password Reset with valid User Id
 * TC-AUT-003: Verify version information display
 */
public class AuthenticationTest extends SmokeBaseTest {
    ...
    @Test(priority = 1, description = "TC-AUT-001 - Verify user can successfully login with valid User Id and Password")
    ...
    @Test(priority = 2, description = "TC-AUT-002 - Verify Password Reset with valid User Id")
    public void TC_AUT_002() {
        ...
        try {
            ...
            Assert.assertTrue(toastMessage.contains("Temporary password has been sent"), "Password reset toast message not displayed correctly.");
    ...
    @Test(priority = 3, description = "TC-AUT-003 - Verify version information display")
    public void TC_AUT_003() {
        ...
        try {
            Assert.assertFalse(actualVersionText.isEmpty(), "Version text is not displayed.");
